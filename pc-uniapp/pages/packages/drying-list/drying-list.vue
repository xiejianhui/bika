	...
	<view class="pageBgW fw500">
		...
		<view class="od-list background-white">
			<view class="item-info" v-if="current_index == 0">
				...
				<view class="member-info flex-align fs28" v-for="(item, index) in orderList" :key="index" @tap="toDetail(item.id)">
					<!-- <navigator :url="'/pages/packages/drying-list/drying-detail/drying-detail?id=' + item.id"> -->
					<view class="member-img mgr30">
						<image src="/static/img/29.png" mode="widthFix"></image>
					</view>
			...
			<view class="item-info" v-if="current_index == 1">
				<view class="member-info relative flex-align fs28 bdbe">
					...
					<view class="right">
						<view class="name title-black fs30 mgb10">fgsdg sdfgsd1</view>
						<view class="gray mgb10">幸运号码：<text class="orange">27272</text></view>
						<view class="gray mgb10">本次享购：<text class="orange">46464</text>人次</view>
						<view class="gray">揭晓时间：<text class="color6">2019-9-9 09:00:00</text></view>
					</view>
			...
			<view class="item-info" v-if="current_index == 2">
				<view class="member-info relative flex-align fs28 bdbe">
					...
					<view class="right">
						<view class="name title-black fs30 mgb10">fgsdg sdfgsd2</view>
						<view class="gray mgb10">幸运号码：<text class="orange">27272</text></view>
						<view class="gray mgb10">本次享购：<text class="orange">46464</text>人次</view>
						<view class="gray">揭晓时间：<text class="color6">2019-9-9 09:00:00</text></view>
					</view>
