	...
	<view class="pageBgW">
		...
		<view class="od-list mgt20 background-white">
			<view class="title flex-equal fs28 fw500">
				<view class="title-item" v-for="(item, index) in titleList" :key="index">{{item.title}}</view>
			</view>
			<view class="title-list flex-equal fs28 fw500">
				<view class="title-item" v-for="(item, index) in orderList" :key="index">{{item.payStatus}}</view>
			</view>
